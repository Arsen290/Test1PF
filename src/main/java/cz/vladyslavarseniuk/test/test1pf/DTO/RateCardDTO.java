...
public class RateCardDTO {
    ...
    public RateCardDTO(String shortName, LocalDateTime validFrom, String name, String country, double move, double amount, double valBuy, double valSell, double valMid, double currBuy, double currSell, double currMid, int version, double cnbMid, double ecbMid) {
